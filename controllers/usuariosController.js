...
const configuracionMulter = {
    limits : { fileSize : 100000 },//Se define en bytes
    storage: fileStorage = multer.diskStorage({
        destination : (req, file, cb) => {
            cb(null, __dirname+'../../public/uploads/perfiles');
        }, 
        filename : (req, file, cb) => {
            //Genera nombre para el archivo
            const extension = file.mimetype.split('/')[1]; //Obtiene el mimetype para la obtener la extensión.
